...
public class PAME extends AbstractClassifier {
	...
	protected Measurement[] getModelMeasurementsImpl() {
		return new Measurement[]{new Measurement("ensemble size",
                ...
                new Measurement("weight 1",this.weights[2]),
                new Measurement("weight 1",this.weights[3]),
                new Measurement("weight 1",this.weights[4]),
                new Measurement("weight 1",this.weights[5]),
                new Measurement("weight 1",this.weights[6]),
                new Measurement("weight 1",this.weights[7]),
                new Measurement("weight 1",this.weights[8]),
                new Measurement("weight 1",this.weights[9]),
                new Measurement("weight 1",this.weights[10]),
                new Measurement("weight 1",this.weights[11]),
                new Measurement("weight 1",this.weights[12]),
                new Measurement("weight 1",this.weights[13]),
                new Measurement("weight 1",this.weights[14]),
                new Measurement("weight 1",this.weights[15]),
                new Measurement("weight 1",this.weights[16]),
                new Measurement("weight 1",this.weights[17]),
                new Measurement("weight 1",this.weights[18]),
                new Measurement("weight 1",this.weights[19]),
                new Measurement("weight 1",this.weights[20]),
                new Measurement("weight 1",this.weights[21]),
                new Measurement("weight 1",this.weights[22]),
                new Measurement("weight 1",this.weights[23]),
                new Measurement("weight 1",this.weights[24]),
                new Measurement("weight 1",this.weights[25]),
                new Measurement("weight 1",this.weights[26]),
                new Measurement("weight 1",this.weights[27]),
                new Measurement("weight 1",this.weights[28]),
                new Measurement("weight 1",this.weights[29]),
                new Measurement("weight 1",this.weights[30]),
                new Measurement("weight 1",this.weights[31]),
                new Measurement("weight 1",this.weights[32]),
                new Measurement("weight 1",this.weights[33]),
                new Measurement("weight 1",this.weights[34]),
                new Measurement("weight 1",this.weights[35]),
                new Measurement("weight 1",this.weights[36]),
                new Measurement("weight 1",this.weights[37]),
                new Measurement("weight 1",this.weights[38]),
                new Measurement("weight 1",this.weights[39]),
                new Measurement("weight 1",this.weights[40]),
                new Measurement("weight 1",this.weights[41]),
                new Measurement("weight 1",this.weights[42]),
                new Measurement("weight 1",this.weights[43]),
                new Measurement("weight 1",this.weights[44]),
                new Measurement("weight 1",this.weights[45]),
                new Measurement("weight 1",this.weights[46]),
                new Measurement("weight 1",this.weights[47]),
                new Measurement("weight 1",this.weights[48]),
                new Measurement("weight 1",this.weights[49]),
                new Measurement("weight 1",this.weights[50]),
                new Measurement("weight 1",this.weights[51]),
                new Measurement("weight 1",this.weights[52]),
                new Measurement("weight 1",this.weights[53]),
                new Measurement("weight 1",this.weights[54]),
                new Measurement("weight 1",this.weights[55]),
                new Measurement("weight 1",this.weights[56]),
                new Measurement("weight 1",this.weights[57]),
                new Measurement("weight 1",this.weights[58]),
                new Measurement("weight 1",this.weights[59]),
                new Measurement("weight 1",this.weights[60]),
                new Measurement("weight 1",this.weights[61]),
                new Measurement("weight 1",this.weights[62]),
                new Measurement("weight 1",this.weights[63]),
                new Measurement("weight 1",this.weights[64]),
                new Measurement("weight 1",this.weights[65]),
                new Measurement("weight 1",this.weights[66]),
                new Measurement("weight 1",this.weights[67]),
                new Measurement("weight 1",this.weights[68]),
                new Measurement("weight 1",this.weights[69]),
                new Measurement("weight 1",this.weights[70]),
                new Measurement("weight 1",this.weights[71]),
                new Measurement("weight 1",this.weights[72]),
                new Measurement("weight 1",this.weights[73]),
                new Measurement("weight 1",this.weights[74]),
                new Measurement("weight 1",this.weights[75]),
                new Measurement("weight 1",this.weights[76]),
                new Measurement("weight 1",this.weights[77]),
                new Measurement("weight 1",this.weights[78]),
                new Measurement("weight 1",this.weights[79]),
                new Measurement("weight 1",this.weights[80]),
                new Measurement("weight 1",this.weights[81]),
                new Measurement("weight 1",this.weights[82]),
                new Measurement("weight 1",this.weights[83]),
                new Measurement("weight 1",this.weights[84]),
                new Measurement("weight 1",this.weights[85]),
                new Measurement("weight 1",this.weights[86]),
                new Measurement("weight 1",this.weights[87]),
                new Measurement("weight 1",this.weights[88]),
                new Measurement("weight 1",this.weights[89]),
                new Measurement("weight 1",this.weights[90]),
                new Measurement("weight 1",this.weights[91]),
                new Measurement("weight 1",this.weights[92]),
                new Measurement("weight 1",this.weights[93]),
                new Measurement("weight 1",this.weights[94]),
                new Measurement("weight 1",this.weights[95]),
                new Measurement("weight 1",this.weights[96]),
                new Measurement("weight 1",this.weights[97]),
                new Measurement("weight 1",this.weights[98]),
                new Measurement("weight 2",this.weights[99])};
	}
