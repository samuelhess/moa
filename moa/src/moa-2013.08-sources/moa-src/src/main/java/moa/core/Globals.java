...
public class Globals {
    ...
    public static final String versionString = "Pre-release 13.08 August 2013";

    public static final String copyrightNotice = "(C) 2007-2013 University of Waikato, Hamilton, New Zealand";
